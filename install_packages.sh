...
if [[ $SAVE_MODE -eq 1 ]]; then
  save_packages
  echo "Packages have been saved to $base_dir/offline-packages.tar.gz"
  echo "Copy $base_dir/offline-packages.tar.gz and $SCRIPT_NAME to the same directory on the air-gapped host then run:"
